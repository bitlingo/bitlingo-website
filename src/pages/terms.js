    ...
    <Layout>
        ...
        <div className={"container"}>
            <div className={"content"}>
                ...
                <p>1.1 These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (<strong>you</strong>), and <strong>HiStaff</strong>, doing business as<strong> HiStaff</strong> <strong>(https://bitlingo.de) </strong>website as well as any related applications (the <strong>Site</strong>). &nbsp;</p>
                ...
                <p><strong>&mdash; </strong>Our Privacy Notice https://bitlingo.de/privacy, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate. &nbsp;</p>
                <p><strong>&mdash; </strong>Our Acceptable Use Policy contact@bitlingo.de, which sets out the permitted uses and prohibited uses of the Site. When using the Site, you must comply with this Acceptable Use Policy. &nbsp;</p>
                <p><strong>&mdash; </strong>Our Cookie Policy https://app.bitlingo.de, which sets out information about the cookies on the Site.</p>

                <h3><strong>2. </strong>&nbsp;<strong>Acceptable Use </strong> </h3>
                <p>2.1 Our full Acceptable Use Policy contact@bitlingo.de, sets out all the permitted uses and prohibited uses of this site. &nbsp;</p>
                ...
                <p>4.3 In posting User Content, including reviews or making contact with other users of the Site you shall comply with our Acceptable Use Policy contact@bitlingo.de. &nbsp;</p>
