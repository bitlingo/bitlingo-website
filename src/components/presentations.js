...
const Presentations = () => (
    <div>
        ...
        {presentationsData.map((presentation, index) => <Presentation key={index} index={index} title={presentation.title} text={presentation.text} picture={presentation.picture} />)  }
    </div>
)
